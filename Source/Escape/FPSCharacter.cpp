...
void AFPSCharacter::RestartLevel()
{
	...
	SetActorLocation(GS->GetCurrentLevelStartTransform().GetTranslation());
	GetController()->SetControlRotation(FRotator(GS->GetCurrentLevelStartTransform().GetRotation()));
